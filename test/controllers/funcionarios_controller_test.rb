...
class FuncionariosControllerTest < ActionController::TestCase
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post :create, funcionario: { cargo: @funcionario.cargo, cel: @funcionario.cel, cep: @funcionario.cep, comissao: @funcionario.comissao, endereco: @funcionario.endereco, nome: @funcionario.nome, salario: @funcionario.salario, tel: @funcionario.tel }
    end
  ...
  test "should update funcionario" do
    patch :update, id: @funcionario, funcionario: { cargo: @funcionario.cargo, cel: @funcionario.cel, cep: @funcionario.cep, comissao: @funcionario.comissao, endereco: @funcionario.endereco, nome: @funcionario.nome, salario: @funcionario.salario, tel: @funcionario.tel }
    assert_redirected_to funcionario_path(assigns(:funcionario))
  end
