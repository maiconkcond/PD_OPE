...
class CaixasControllerTest < ActionController::TestCase
  ...
  test "should create caixa" do
    assert_difference('Caixa.count') do
      post :create, caixa: { data: @caixa.data, soma_geral: @caixa.soma_geral, valor_inicial: @caixa.valor_inicial }
    end
  ...
  test "should update caixa" do
    patch :update, id: @caixa, caixa: { data: @caixa.data, soma_geral: @caixa.soma_geral, valor_inicial: @caixa.valor_inicial }
    assert_redirected_to caixa_path(assigns(:caixa))
  end
